...
function onEditButton(button) {
    button.addEventListener('click', (e) => {
        ...
        document.querySelector('#editUsername').value = tr.children[1].innerHTML;
        document.querySelector('#editName').value = tr.children[2].innerHTML;
        document.querySelector('#editHobby').value = tr.children[3].innerHTML;
...
function onDeleteButton(button) {
    button.addEventListener('click', (e) => {
        ...
        document.querySelector('#deleteUsername').value = tr.children[2].innerHTML;
        document.querySelector('#deleteName').value = tr.children[2].innerHTML;
        document.querySelector('#deleteHobby').value = tr.children[3].innerHTML;
    ...
    document.querySelector('#editBtnSubmit').addEventListener('click', async (e) => {
        ...
        await fetch(url, {
            ...
            body: JSON.stringify({
                ...
                hobby: document.querySelector('#editHobby').value,
